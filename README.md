# plugin-grade-7-physics-length

Standalone lecture-plugin repo for **`grade-7.physics.length`**, deployed to the ed-tech
...
```
https://cdn.jsdelivr.net/gh/<owner>/plugin-grade-7-physics-length@v<version>/dist/index.js
```
